...
export const useTestStore = defineStore('test', () => {
    const testlist = reactive([
        ...
        { id: 'hys', testName: 'HYS', img: 'female/wonyong.jpg', detail: '測驗聽到歌曲後你能多快選出正確的歌曲名稱，考驗平時的學習量。依照題數及總時間去計算平均每題的猜題時間，得出你的甜牌位！', device: 'desktop', level: '難', name: 'HYS', title: 'HYS' },
        { id: 'ken', testName: 'ken', img: 'female/anime.jpg', detail: '測驗聽到歌曲後你能多快選出正確的歌曲名稱，考驗平時的學習量。依照題數及總時間去計算平均每題的猜題時間，得出你的甜牌位！', device: 'desktop', level: '難', name: 'ken', title: 'ken' },
    ])
